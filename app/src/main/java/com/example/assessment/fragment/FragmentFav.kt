...
import com.example.assessment.adapter.FavAdapter
import com.example.assessment.databinding.FragmentListBinding
import com.example.assessment.retrofit.SharedPref
import com.google.gson.Gson

class FragmentFav : Fragment(R.layout.fragment_list) {
    var arrayList = arrayListOf<ProductsItem>()
    ...
    override fun onResume() {
        super.onResume()
        arrayList = appSharedPref.getFavList(getString(R.string.favProduct))
        setAdapter()
    ...
    private fun setAdapter() {
        ...
        adapter = FavAdapter(arrayList, object : FavAdapter.BtnClickListener {
            ...
            override fun onItemClick(position: Int) {
                ...
                intent.putExtra(getString(R.string.Data), gson.toJson(arrayList[position]))
            ...
            override fun onFavClick(position: Int, imgFav: CheckBox) {
                if (!imgFav.isChecked) {
                    ...
                    appSharedPref.putFavList(getString(R.string.favProduct), arrayList)
